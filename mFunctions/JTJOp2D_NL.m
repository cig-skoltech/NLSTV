function v = JTJOp2D_NL(f,W,idx,n,I,bc)
%
...
% patch_size=[3 3]; win_size=[9 9]; K=9;h=0.25^2;
% [W,C]=NL_wdist(f,patch_size,win_size,'K',9);
% W=exp(-W/h);
% [idx,n,I]=compute_Nsum_indices(C);
% tic,JTJf=AdjJacobianOp2D_NL(JacobianOp2D_NL(f,sqrt(W),C),sqrt(W),idx,n,I);toc
% tic,JTJf_alt=JTJOp2D_NL(f,sqrt(W),idx,n,I);toc
% e=JTJf_alt(:)-JTJf(:); [min(e(:)), max(e(:))]
